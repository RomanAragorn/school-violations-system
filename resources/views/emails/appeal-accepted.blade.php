...
<head>
    ...
    <title>Appeal Accepted Notice</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 16px 24px 8px 24px;">
                            ...
                            <p style="margin: 0 0 16px; font-size: 14px;">
                                We are pleased to inform you that your appeal regarding the disciplinary
                                violation described below has been <strong>accepted</strong> after careful review.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 8px 24px 4px 24px;">
                            <p style="margin: 0 0 10px; font-size: 13px;">
                                The original sanction for this violation has now been dismissed. Please personally
                                report to the Discipline Office at your earliest convenience after receiving this
                                email to acknowledge this decision and receive any further instructions.
                            </p>
                            <p style="margin: 0 0 10px; font-size: 13px;">
                                If you have any questions or need clarification, you may visit the
